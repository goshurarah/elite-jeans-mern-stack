...
const EditTechPackModal = ({ isOpen, closeModal, onSubmit, techPackData }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    setError(null);
    try {
      const response = await axios.put(`/api/techPack/${test}`, formData);
  ...
  return (
    <Modal open={isOpen} onClose={closeModal}>
      <Box sx={modalStyles}>
        <Typography variant="h6" gutterBottom>Edit Tech Pack Order</Typography>
...
export default EditTechPackModal;
