...
function AddPriceModal({ open, handleClose, itemDetailId, handleSubmitSent }) {
  ...
  const handleSubmit = () => {
    ...
    axios
      .post("/api/work-orders/quotes-with-contract/itemDetailId", payload)
      .then((response) => {
    ...
    <Modal open={open} onClose={handleClose}>
      ...
      >
        <Typography variant="h6" sx={{ marginBottom: 2 }}>
          Add Price for WorkOrder
        </Typography>

        {/* Vendor */}
        <FormControl fullWidth sx={{ marginBottom: 2 }}>
          <InputLabel>Vendor</InputLabel>
          <Select value={vendor} onChange={handleVendorChange} label="Vendor">
